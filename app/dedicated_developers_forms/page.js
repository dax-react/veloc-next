// app/quote/page.js or pages/quote.js (depending on your Next.js version)
...
export default function dedicated_developers_form() {
            ...
            <div style={styles.optionsContainer}>
                <div style={styles.optionCard} onClick={() => handleTeamTypeSelect('Dedicated team (POD)', '200 hrs + PM + QA - $4K - $10K/mo')}>
                    <div style={styles.illustration}>
                        <Image src={dedicated_team} alt="dd team" width={200} height={150} style={{ width: '70%', height: 'auto' }} />
                    </div>
                ...
                <div style={styles.optionCard} onClick={() => {
                    ...
                    <div style={styles.illustration}>
                        <Image src={dedicated_dev} alt="dd dev" width={200} height={150} style={{ width: '70%', height: 'auto' }} />
                    </div>
