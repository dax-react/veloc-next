...
export default function ProjectContent({ slug, initialProject }) {
    ...
    useEffect(() => {
        if (project) document.title = project.title;
    }, [project]);

    if (!project) notFound();

    const handleNextProject = () => {
        if (project.nextProject) router.push(`/projects/${project.nextProject}`);
    };
        ...
        <>
            ...
            <div className="background-about">
                <Box className="project-wrapper">
                    <Box className="project-container">
                        ...
                        <Typography variant="body2" className="project-description" data-aos="fade-up" data-aos-delay="100">
                            {project.description}
                        </Typography>
                ...
                <div className="kids-portal-wrapper">
                    <div className="kids-portal-container">
                        <h2 className="kids-portal-title" data-aos="fade-right">{project.title}</h2>
                        <div className="kids-portal-description">
                            {project.detailedDescription.map((p, i) => (
                                <p key={i} data-aos="fade-up" data-aos-delay={(i + 1) * 100}>{p}</p>
                            ))}
                        </div>
                    </div>
                </div>
                        ...
                        <div className="right-section">
                            {project.images[2] && (
                                <div className="image-wrapper small" data-aos="fade-left" data-aos-delay="100">
                                    <img src={project.images[2].url} alt={project.images[2].alt} style={{ margin: "10px" }} />
                                </div>
                            )}
                            {project.images[3] && (
                ...
                <div className="profile-container">
                    <div className="profile-card" data-aos="flip-left" data-aos-duration="1200">
                        <div className="profile-header">
                            <img src={project.profile.image} alt={project.profile.name} className="profile-image" data-aos="zoom-in" data-aos-delay="200" />
                            <h2 className="profile-name" data-aos="fade-up" data-aos-delay="300">{project.profile.name}</h2>
                        </div>
                        <div className="profile-content">
                            <p className="profile-text" data-aos="fade-up" data-aos-delay="400">{project.profile.text}</p>
                            <p className="profile-title" data-aos="fade-up" data-aos-delay="500">{project.profile.title}</p>
                        </div>
                    </div>
                </div>
                ...
                {nextProjectData && (
                    <div className="hero-container">
                        <div className="hero-content" data-aos="fade-up" data-aos-duration="1200">
                            <h1 className="hero-title" data-aos="fade-down" data-aos-delay="100">{nextProjectData.title}</h1>
                            <button className="hero-button" data-aos="zoom-in" data-aos-delay="300" onClick={handleNextProject}>
            ...
            <div className="hero-wrapper-shopify">
                <div className="hero-content">
                    <Typography variant="h2" className="hero-title">Let&apos;s Start Building Your</Typography>
                    <Typography variant="h2" className="hero-subtitle" data-delay="100">
                        Brand&apos;s unique Story{" "}
                        <span style={{ fontFamily: "Space Grotesk, sans-serif", fontWeight: 400, fontSize: "96px", lineHeight: "110px", letterSpacing: "-0.03em", color: "rgba(66, 48, 196, 1)" }}>Together</span>
                    </Typography>
                    ...
                    <div>
                        <button className="connect-button">
                            <svg className="icon" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20 5L5 20L20 35L35 20L20 5Z" stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round" fill="none" />
                                <path d="M20 5L35 20M5 20L20 35" stroke="currentColor" strokeWidth="2.5" />
                            </svg>
