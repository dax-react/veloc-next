...
export default function Gymflex() {
    ...
    const images = [
        { id: 1, url: "/images/gymflex1.png", alt: "Image 1" },
        { id: 3, url: "/images/gymflex3.png", alt: "Image 3" },
        { id: 2, url: "/images/gymflex2.png", alt: "Image 2" },
        { id: 4, url: "/images/gymflex4.png", alt: "Image 4" },
        { id: 5, url: "/images/gymflex5.png", alt: "Image 5" },
                ...
                <Box className="project-wrapper">
                    <Box className="project-container">
                        ...
                        >
                            ...
                            online buying easier. With clean UI, fast navigation, and secure payment options,
                            it allows users to browse products, add them to cart, and complete their purchase
                            within minutes.
                        </Typography>
                ...
                <div className="kids-portal-wrapper">
                    <div className="kids-portal-container">
                        ...
                        <div className="kids-portal-description">
                            {[100, 200, 300].map((delay, i) => (
                                <p key={i} data-aos="fade-up" data-aos-delay={delay}>
                                    SmartShop is a simple and user-friendly mobile shopping app designed to make
            ...
            <div className="carousel-container">
                <div className="carousel">
                    <div className="carousel-track">
                        <img src={footerlogo} alt="Trusted Logos Duplicate" />
                        <img src={footerlogo} alt="Trusted Logos Duplicate" />
                    </div>
                </div>
            </div>
